...
-   If your location is not using directed put-away and pick (basic warehouse configuration), you use the **Phys. Inventory Journal** page in the **Stock** menu, and the procedure is much the same as when you conduct a physical inventory without cycle counting.  
...
1. On the **Phys. Inventory Journal** page containing the calculated expected stock, Choose the **Print** action.
...
1. On each line on the **Phys. Inventory Journal** page where the actual stock on hand, as determined by the physical count, differs from the calculated quantity, enter the actual stock on hand in the **Qty. (Phys. Stock)** field.
...
Synchronise item ledger and warehouse before you perform the warehouse physical stock, otherwise the results you post to the physical inventory journal and item ledger in the final part of the process will be the physical stock results combined with other warehouse adjustments for the items that were counted. For more information, see [synchronise quantities in the item ledger and warehouse](inventory-how-count-adjust-reclassify.md#to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries)
...
1. When the counting is done, enter the counted quantities in the **Qty. (Phys. Stock)** field in the warehouse physical inventory journal.  
