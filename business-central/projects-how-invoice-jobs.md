...
8. On the **Project Planning Lines** page, choose the **Sales Invoices/CR/Adj Notes** action.
...
> [!NOTE]  
> The above procedure is similar for creating, reviewing, and posting a project-related sales CR/Adj note.
