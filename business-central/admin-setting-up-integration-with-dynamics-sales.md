...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse"></a><a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse"></a>Setting Up User Accounts for Integrating with Microsoft Dataverse
...
## <a name="set-up-the-administrator-user-account"></a><a name="set-up-the-administrator-user-account"></a>Set up the administrator user account
...
## <a name="permissions-and-security-roles-for-user-accounts-in-"></a><a name="permissions-and-security-roles-for-user-accounts-in-"></a>Permissions and security roles for user accounts in [!INCLUDE[prod_short](includes/cds_long_md.md)]
