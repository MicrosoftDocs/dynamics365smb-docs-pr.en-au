...
- Applying payments to invoices or CR/Adj Notes
    ...
    If you fill in the **Applies-to Doc. No.** field with the invoice or CR/Adj note to pay or refund, the document is set to **Paid** when you post the journal. This setting is referred to as "applied." As an alternative to applying when you post a payment, you can use the **Apply Vendor Entries** and **Apply Customer Entries** pages after you post the payment. To learn more, go to, for example, [Reconcile Vendor Payments with the Payment Journal or from Vendor Ledger Entries](payables-how-apply-purchase-transactions-manually.md).  
