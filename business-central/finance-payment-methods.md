...
CR/Adj notes for returns, however, are exceptions because money is flowing in the opposite directions, from you to your customer and from your supplier to you. Therefore, a default payment method is not assigned to CR/Adj Notes. There is, however, a workaround if you have specified terms of payment for the customer or supplier. Though the **Calc. Pmt. Disc. on CR/Adj Notes** field is not intended for this, if you choose the check box on the **Payment Terms** page a default payment method will be added when you create a CR/Adj Note. <br><br>  
