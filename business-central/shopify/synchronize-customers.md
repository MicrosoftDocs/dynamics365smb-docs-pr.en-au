...
3. In some cases, **Customer Template Code** defined for country isn't enough to ensure right calculation of taxes. For example, for countries with GST. In this case, the **Tax Areas** could be a useful addition.
