...
# <a name="synchronize-customers"></a><a name="synchronize-customers"></a>Synchronise Customers
...
## <a name="important-settings-when-importing-customers-from-shopify"></a><a name="important-settings-when-importing-customers-from-shopify"></a>Important settings when importing customers from Shopify
...
### <a name="customer-template-per-country"></a><a name="customer-template-per-country"></a>Customer template per country
...
## <a name="export-customers-to-shopify"></a><a name="export-customers-to-shopify"></a>Export customers to Shopify
...
### <a name="populate-customer-information-in-shopify"></a><a name="populate-customer-information-in-shopify"></a>Populate customer information in Shopify
...
## <a name="sync-customers"></a><a name="sync-customers"></a>Sync customers
