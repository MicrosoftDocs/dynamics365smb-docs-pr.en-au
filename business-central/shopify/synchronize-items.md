...
### <a name="price-synchronization-for-b2b"></a>Price synchronization for B2B
...
#### <a name="synchronize-catalogs-from-the-shopify"></a>Synchronize catalogs from the Shopify

1. Select the ![Lightbulb that opens the Tell Me feature.](../media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Shopify Catalogues**, and select the related link.
2. Select **Get Catalogues**.
...
#### <a name="sync-prices-for-b2b-catalog"></a>Sync prices for B2B Catalog
...
5. Choose **Sync Prices** and wait until synchronisation of prices is completed.
