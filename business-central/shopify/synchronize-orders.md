...
>[!Note]
>The return location, including blank locations, defined in the **Shopify Shop Card** are used on the created CR/Adj note. The system ignores the original locations from orders or shipments.
