...
In the **Tax area source** field, you can define priority on how to select tax area code or GST business posting group based on address. This step is relevant for countries with GST, but can be used for VAT countries. For more information, see [Tax remarks](synchronize-orders.md#tax-remarks).
