...
|Edit an order and decrease quantity|Imported order will use new quantity. Shopify refund with 0 amount will be imported that can not be converted into CR/Adj Note.| Connector will detect change and mark orders. |
|Edit an order and remove existing item |Removed item won't be imported. Shopify refund with 0 amount will be imported that can not be converted into CR/Adj Note.| Connector will detect change and mark orders. |
...
|Cancel unpaid order | Removed item won't be imported. Shopify refund with 0 amount will be imported that can not be converted into CR/Adj Note. |Connector will detect change and mark orders. |
