...
In the **Tax area source** field, you can set the priority on how to select tax area code or GST business posting group based on address. This step is relevant for countries with GST. Learn more at [Tax remarks](synchronize-orders.md#tax-remarks).
...
- Price including Tax. The **Prices including Tax**/**Prices including GST** field in the created sales document doesn't depend on the customer, but on the **Customer Template** from the **Shopify Shop Card** page or Customer template per country.
