...
### <a name="collect-vat-set-to-one-stop-shop-registration" />Collect GST set to one-stop shop registration
...
### <a name="collect-vat-set-to-micro-business-exemption" />Collect GST set to micro-business exemption
