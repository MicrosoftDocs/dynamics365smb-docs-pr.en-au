...
ms.author: edupont
---
# <a name="set-up-withholding-tax-in-the-australian-version" />Set Up Withholding Tax in the Australian Version
...
## <a name="to-enable-withholding-tax" />To enable withholding tax
