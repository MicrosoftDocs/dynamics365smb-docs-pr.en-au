...
ms.author: edupont
---
# <a name="set-up-withholding-tax-in-the-australian-version"></a><a name="set-up-withholding-tax-in-the-australian-version"></a><a name="set-up-withholding-tax-in-the-australian-version"></a>Set Up Withholding Tax in the Australian Version
...
## <a name="to-enable-withholding-tax"></a><a name="to-enable-withholding-tax"></a><a name="to-enable-withholding-tax"></a>To enable withholding tax
