...
ms.author: soalex
---
# <a name="payment-times-reporting-in-the-australian-version" />Payment Times Reporting in the Australian Version
...
## <a name="support-for-payment-times-reporting-in-business-central" />Support for Payment Times Reporting in Business Central
...
## <a name="reporting-the-payment-times" />Reporting the Payment Times
...
### <a name="marking-a-vendor-as-a-small-business-vendor" />Marking a vendor as a Small Business Vendor
...
### <a name="the-reporting-data" />The reporting data
...
### <a name="finding-the-data-for-the-payment-times-report" />Finding the data for the Payment Times Report
...
#### <a name="to-find-vendor-ledger-entries" />To find vendor ledger entries
