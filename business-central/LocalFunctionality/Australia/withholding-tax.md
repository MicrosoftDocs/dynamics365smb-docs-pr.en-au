...
ms.author: edupont
---
# <a name="withholding-tax-in-the-australian-version" />Withholding Tax in the Australian Version
...
## <a name="wht-for-suppliers-without-an-abn" />WHT for Suppliers Without an ABN
