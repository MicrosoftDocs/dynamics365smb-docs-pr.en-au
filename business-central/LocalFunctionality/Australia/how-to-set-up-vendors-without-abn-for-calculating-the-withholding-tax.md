...
ms.author: edupont
---
# <a name="set-up-vendors-without-abn-for-calculating-the-withholding-tax-in-the-australian-version" />Set Up Vendors Without ABN for Calculating the Withholding Tax in the Australian Version
...
## <a name="to-set-up-vendors-without-abn-for-calculating-the-withholding-tax" />To set up vendors without ABN for calculating the withholding tax
