...
## <a name="to-set-up-delivery-reminder-terms" />To set up delivery reminder terms
...
## <a name="to-add-delivery-reminder-levels-to-a-delivery-reminder-term" />To add delivery reminder levels to a delivery reminder term
...
## <a name="to-set-up-delivery-reminder-text-messages" />To set up delivery reminder text messages
