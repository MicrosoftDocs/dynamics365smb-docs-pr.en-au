...
## <a name="to-create-a-check-installment"></a><a name="to-create-a-check-installment"></a><a name="to-create-a-check-installment"></a><a name="to-create-a-check-installment"></a>To create a cheque instalment
