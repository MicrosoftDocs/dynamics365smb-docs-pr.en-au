...
---
## <a name="set-up-wht-posting-groups" /><a name="set-up-wht-posting-groups"></a>Set up WHT posting groups
...
### <a name="to-set-up-a-product-posting-group-for-withholding-tax" /><a name="to-set-up-a-product-posting-group-for-withholding-tax"></a>To set up a product posting group for withholding tax
...
### <a name="to-set-up-posting-for-withholding-tax" /><a name="to-set-up-posting-for-withholding-tax"></a>To set up posting for withholding tax
