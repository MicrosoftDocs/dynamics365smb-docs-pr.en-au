...
### <a name="to-create-a-credit-memo-for-vat-difference" />To create a CR/Adj Note for GST difference
...
### <a name="to-create-a-new-credit-memo" />To create a new CR/Adj Note
