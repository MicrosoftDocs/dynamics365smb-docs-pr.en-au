...
ms.locfileid: "9077198"
---
# <a name="make-check-payments"></a>Make Cheque Payments

You can issue electronic and manual checks in [!INCLUDE[prod_short](includes/prod_short.md)]. Both methods use the payment journal to issue cheques to suppliers. You can also void cheques and view cheque ledger entries.
