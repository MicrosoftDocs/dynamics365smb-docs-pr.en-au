...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries"></a><a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries"></a>To apply a CR/Adj note to a single or multiple vendor ledger entries
