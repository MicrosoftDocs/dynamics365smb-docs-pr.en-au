---
title: Reconcile supplier payment receipts or refunds in the receipt journal
...
ms.locfileid: "6437249"
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries"></a>Reconcile Supplier Payments with the Receipt Journal or from Supplier Ledger Entries
...
> [!NOTE]  
>   Suppliers may sometimes give a payment refund instead of a CR/Adj note to offset against future invoices, especially when you return items that you have already paid for or when you have overpaid an invoice.
...
You can apply supplier payments manually to their related purchase documents when you post the payments on the **Receipt Journal** page. For information about filling the receipt journal, see [Making Payments](payables-make-payments.md).
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries"></a>To apply a CR/Adj note to a single or multiple supplier ledger entries
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Purchase CR/Adj Note**, and then choose the related link.
