...
ms.locfileid: "3920586"
---
# <a name="report-vat-to-tax-authorities"></a>Report GST to Tax Authorities
This topic describes the reports in [!INCLUDE[d365fin](includes/d365fin_md.md)] that you can use to submit information about value-added tax (GST) amounts for sales and purchases to tax authorities in your region. 
