...
# <a name="report-vat-to-tax-authorities" />Report GST to Tax Authorities
...
## <a name="a-namevatreturnaabout-the-vat-return-report" /><a name="vatreturn"></a>About the GST Return report
...
## <a name="to-set-up-vat-reports-in-includeprodshortincludesprodshortmd" />To set up GST reports in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods" />To set up GST return periods
...
## <a name="to-prepare-and-submit-a-vat-report" />To prepare and submit a GST report
...
### <a name="vat-return-statuses" />GST return statuses
...
## <a name="submitting-vat-reports-manually" />Submitting GST reports manually
...
## <a name="vat-settlement" />GST settlement
...
## <a name="configuring-your-own-vat-reports" />Configuring your own GST reports
