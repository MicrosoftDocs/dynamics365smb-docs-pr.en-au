...
## <a name="about-the-vat-return-report" /><a name="vatreturn"></a>About the GST Return report
...
## <a name="to-set-up-vat-reports-in-" />To set up GST reports in [!INCLUDE[prod_short](includes/prod_short.md)]
