...
2. Open the **General** FastTab and fill the fields as necessary. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] The table below describes some of the key fields:
   ...
   | **Company GST No. on File** | Specifies how the company's exemption certification number exports to the Intrastat file. You can choose one of the options: Exempt. Cert. No., adding the EU Country Code as a prefix and removing the EU Country Code from Exempt. Cert. No. |
   | **Vendor GST No. on File** | Specifies how a vendor's exemption certification number is exported to the Intrastat file. You can choose one of the options: Exempt. Cert. No., adding the EU Country Code as a prefix and removing the EU Country Code from Exempt. Cert. No. |
   | **Customer GST No. on File** | Specifies how a customer's exemption certification number is exported to the Intrastat file. You can choose one of the options: Exempt. Cert. No., adding the EU Country Code as a prefix and removing the EU Country Code from Exempt. Cert. No. |
   | **Get Partner GST** | Specifies which type of **Intrastat Report** line the Partner's exemption certification number is updated from. Depending on your local requirements, you can choose only for receipt, only for shipment, or for both types of lines. |
...
Before using a vendor in Intrastat reporting, you must have a dedicated **Country/Region Code** and **Exemption Certificate No.** for each of them, in addition to further information on their **Vendor Card** page:
...
Before using a customer in Intrastat reporting, you must have a dedicated **Country/Region Code** and **Exemption Certificate No.** for each of them, in addition to further information on their **Customer Card** page:
