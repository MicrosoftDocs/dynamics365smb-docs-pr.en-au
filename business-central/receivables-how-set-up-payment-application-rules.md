...
- Automatically apply payments to their related open (unpaid) invoices, CR/Adj notes, or other entries when you use the **Apply Automatically** function on the **Payment Reconciliation Journal** page. For more information, see [Reconcile Payments Using Automatic Application](receivables-how-reconcile-payments-auto-application.md).
...
- For negative amounts, a match is made first against open entries representing customer invoices and then against vendor CR/Adj notes.
- For positive amounts, a match is made first against open entries representing vendor invoices and then against customer CR/Adj notes.
...
| High             | Deferred Company Fund Instalment (7)        | Partially             | Yes                            | One Match                      |
...
| Medium           | Deferred Company Fund Instalment (7)        | No                    | Yes-Multiple                   | Not Considered                 |
