...
## <a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry" />To apply a CR/Adj note to a single customer ledger entry
...
## <a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries" />To apply a CR/Adj note to multiple customer ledger entries
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Sales CR/Adj Notes**, and then choose the related link.
2. Open the relevant sales CR/adj note.
