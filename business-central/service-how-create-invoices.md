...
description: Learn how to use Business Central to seamlessly create credit invoices and CR/Adj notes for your services.
author: brentholtorf
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos"></a><a name="create-service-invoices-or-credit-memos"></a><a name="create-service-invoices-or-credit-memos"></a>Create Service Invoices or CR/Adj Notes
...
## <a name="to-create-a-service-credit-memo"></a><a name="to-create-a-service-credit-memo"></a><a name="to-create-a-service-credit-memo"></a>To create a service CR/Adj Note
