...
description: Learn how to create invoices and CR/Adj notes for your services.
author: brentholtorf
ms.author: bholtorf
...
---
# <a name="create-service-invoices-or-credit-memos"></a>Create service invoices or CR/Adj notes
...
You typically use a service CR/Adj note document when a customer returns an item. However, you can also use them to reimburse a customer or to correct a invoice that was a mistake.  
