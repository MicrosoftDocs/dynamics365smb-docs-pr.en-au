...
* In the **Supplier Invoice No.** field, **Supplier Order No.** field, or the **Supplier CR/Adj Note No.** field on a purchase header

* In the **External Document No.** field on a general journal line, where the **Document Type** field is set to *Invoice*, *CR/Adj Note*, or *Finance Charge Memo*, and the **Account Type** field is set to *Supplier*.
