...
# <a name="set-up-non-deductible-vat" />Set up non-deductible GST
...
## <a name="use-non-deductible-vat" />Use non-deductible GST
...
## <a name="use-the-non-deductible-vat-percentage" />Use the non-deductible GST percentage
...
2. On the **GST Posting Setup** page, set the fields as described in the following table.
    ...
    | Non-Deductible Input Tax Credit Account | Specify the account that's associated with the GST amount that isn't deducted because of the type of goods or services that are purchased. |
