...
## <a name="create-time-sheets"></a>To create time sheets
...
| Service | Use to register time usage for a service order or service CR/Adj note. |
...
## <a name="reuse-time-sheet-lines-in-other-time-sheets"></a>To reuse time sheet lines in other time sheets
...
## <a name="copy-job-planning-lines-to-a-time-sheet"></a>To copy job planning lines to a time sheet
...
## <a name="define-work-types-and-add-one-to-a-time-sheet"></a>To define work types and add one to a time sheet
...
## <a name="fill-in-time-sheet-lines-and-submit-for-approval"></a>To fill in time sheet lines and submit for approval
...
## <a name="reopen-a-time-sheet"></a>To reopen a time sheet
...
## <a name="view-and-approve-time-sheets-by-job"></a>To view and approve time sheets by job
...
### <a name="approve-or-reject-a-time-sheet-by-job"></a>To approve or reject a time sheet by job
...
## <a name="post-time-sheet-lines-in-a-resource-journal"></a>To post time sheet lines in a resource journal
...
## <a name="post-time-sheet-lines-in-a-job-journal"></a>To post time sheet lines in a job journal
