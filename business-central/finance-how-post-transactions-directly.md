...
Entries that you post with documents require a CR/Adj note process. However, you can reverse entries that you post with the general journal. For more information, see [Reverse Journal Postings and Undo Receipts/Shipments](finance-how-reverse-journal-posting.md).
