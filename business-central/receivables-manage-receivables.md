...
ms.locfileid: "6323576"
---
# <a name="managing-receivables"></a>Managing Receivables

A regular step in any financial rhythm is to reconcile bank accounts, which requires that you apply incoming payments to customer or supplier ledger entries to close sales invoices and purchase CR/Adj notes as paid.
