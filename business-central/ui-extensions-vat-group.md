...
---
# <a name="the-vat-group-management-extension-for-the-united-kingdom" /><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>The GST Group Management Extension for the United Kingdom
...
## <a name="forming-a-vat-group" /><a name="forming-a-vat-group"></a>Forming a GST group
...
### <a name="license-requirements" /><a name="license-requirements"></a>Licence requirements
...
## <a name="set-up-a-vat-group" /><a name="set-up-a-vat-group"></a>Set up a GST group
...
### <a name="azure-active-directory-setup-for-group-members" /><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory setup for group members
...
### <a name="group-api-setup" /><a name="group-api-setup"></a>Group API setup
...
## <a name="set-up-vat-group-members" /><a name="set-up-vat-group-members"></a>Set up GST group members
...
### <a name="vat-group-representative-uses-business-central-online" /><a name="vat-group-representative-uses-business-central-online"></a>GST group representative uses Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises" /><a name="vat-group-representative-uses-business-central-on-premises"></a>GST group representative uses Business Central on-premises
...
## <a name="set-up-the-vat-group-representative" /><a name="set-up-the-vat-group-representative"></a>Set up the GST group representative
...
## <a name="use-the-vat-group-management-features" /><a name="use-the-vat-group-management-features"></a>Use the GST group management features
...
### <a name="review-vat-member-submissions" /><a name="review-vat-member-submissions"></a>Review GST member submissions
...
### <a name="create-a-group-vat-return" /><a name="create-a-group-vat-return"></a>Create a group GST return
