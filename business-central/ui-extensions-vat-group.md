...
ms.locfileid: "9361537"
---
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>The GST Group Management Extension for the United Kingdom
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>Forming a GST group
...
### <a name="license-requirements"></a><a name="license-requirements"></a><a name="license-requirements"></a><a name="license-requirements"></a>Licence requirements
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Set up a GST group
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory setup for group members
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a><a name="group-api-setup"></a><a name="group-api-setup"></a>Group API setup
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Set up GST group members
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>GST group representative uses Business Central online
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>Set up the GST group representative
...
4. In the **Group Settlement Account** field, specify the settlement account used for the group member GST tax amounts.
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>Use the GST group management features
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Review GST member submissions
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Create a group GST return
