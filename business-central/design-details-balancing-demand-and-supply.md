...
Another reason that serial numbered supply is inflexible is that serial numbers are generally assigned so late in the process that it would be confusing if changes are suggested.  
