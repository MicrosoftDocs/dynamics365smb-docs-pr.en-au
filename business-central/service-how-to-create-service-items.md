...
- Service Line (except for service CR/Adj notes, where you'll see a notification that the item or variant is blocked, but allowed on this type of document)
- Service Item
...
- Service Item Line (except for service CR/Adj notes, if blocked for all)
