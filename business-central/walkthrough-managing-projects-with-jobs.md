...
---
# <a name="walkthrough-managing-projects-with-jobs" /><a name="walkthrough-managing-projects-with-jobs"></a>Walkthrough: Managing Projects with Jobs
...
## <a name="about-this-walkthrough" /><a name="about-this-walkthrough"></a>About This Walkthrough
...
### <a name="copying-a-job" /><a name="copying-a-job"></a>Copying a Job
...
### <a name="making-payment-by-installment" /><a name="making-payment-by-installment"></a>Making Payment by Installment
...
## <a name="roles" /><a name="roles"></a>Roles
...
## <a name="prerequisites" /><a name="prerequisites"></a>Prerequisites
...
## <a name="story" /><a name="story"></a>Story
...
## <a name="preparing-sample-data" /><a name="preparing-sample-data"></a>Preparing Sample Data

 To prepare for this walkthrough, you must add Tricia as a new resource.  

### <a name="to-prepare-the-sample-data" /><a name="to-prepare-the-sample-data"></a>To prepare the sample data
...
### <a name="to-create-a-job-journal-batch" /><a name="to-create-a-job-journal-batch"></a>To create a Job Journal batch
...
### <a name="to-set-up-a-job" /><a name="to-set-up-a-job"></a>To set up a job
...
### <a name="to-customize-pricing" /><a name="to-customize-pricing"></a>To customise pricing
...
### <a name="to-add-job-tasks" /><a name="to-add-job-tasks"></a>To add job tasks
...
### <a name="to-create-planning-lines" /><a name="to-create-planning-lines"></a>To create planning lines
...
## <a name="calculating-remaining-usage" /><a name="calculating-remaining-usage"></a>Calculating Remaining Usage
...
### <a name="to-calculate-remaining-usage" /><a name="to-calculate-remaining-usage"></a>To calculate remaining usage
...
## <a name="creating-and-posting-a-job-sales-invoice" /><a name="creating-and-posting-a-job-sales-invoice"></a>Creating and Posting a Job Sales Invoice
...
### <a name="to-create-a-job-sales-invoice" /><a name="to-create-a-job-sales-invoice"></a>To create a job sales invoice
...
### <a name="to-post-a-new-sales-invoice" /><a name="to-post-a-new-sales-invoice"></a>To post a new sales invoice
...
### <a name="to-view-the-posted-invoice" /><a name="to-view-the-posted-invoice"></a>To view the posted invoice
...
### <a name="to-open-the-statistics-page" /><a name="to-open-the-statistics-page"></a>To open the Statistics page
...
### <a name="to-manage-fixed-pricing-in-jobs" /><a name="to-manage-fixed-pricing-in-jobs"></a>To manage fixed pricing in jobs
...
### <a name="to-enter-hours-in-the-job-journal" /><a name="to-enter-hours-in-the-job-journal"></a>To enter hours in the Job Journal
...
## <a name="copying-jobs" /><a name="copying-jobs"></a>Copying Jobs
...
### <a name="to-copy-a-job" /><a name="to-copy-a-job"></a>To copy a job
...
## <a name="making-payments-by-installments" /><a name="making-payments-by-installments"></a>Making Payments by Installments
...
### <a name="to-set-up-a-new-account" /><a name="to-set-up-a-new-account"></a>To set up a new account
...
### <a name="to-make-a-payment-by-installment" /><a name="to-make-a-payment-by-installment"></a>To make a payment by installment
...
### <a name="to-create-an-invoice" /><a name="to-create-an-invoice"></a>To create an invoice
...
## <a name="next-steps" /><a name="next-steps"></a>Next Steps
