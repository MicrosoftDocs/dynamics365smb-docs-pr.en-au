...
6.  On the **Foreign Trade** FastTab, set the currency code to **AUD**. If you select AUD in the **Invoice Currency Code** field, then the job will be invoiced in Australian dollar(s) and planned in the local currency of CRONUS only.  
