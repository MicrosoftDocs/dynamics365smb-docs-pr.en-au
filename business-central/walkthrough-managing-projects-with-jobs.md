...
6. On the **Foreign Trade** FastTab, set the currency code to **AUD**. If you select AUD in the **Invoice Currency Code** field, then the project will be invoiced in Australian dollars and planned in the local currency of CRONUS only.  
