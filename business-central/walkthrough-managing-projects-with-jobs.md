...
## <a name="setting-up-a-job-1"></a><a name="setting-up-a-job"></a>Setting Up a Job
...
## <a name="handling-fixed-prices-1"></a><a name="handling-fixed-prices"></a>Handling Fixed Prices
