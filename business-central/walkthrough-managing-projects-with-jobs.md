...
6. On the **Foreign Trade** FastTab, set the currency code to **AUD**. If you select AUD in the **Invoice Currency Code** field, the project is invoiced in Australian Dollar and planned in the local currency of CRONUS only.  
...
2. Select any of the planning lines that were invoiced, and then choose the **Sales Invoice/CR/Adj Note** action.
3. On the **Project Invoices** page, choose the **Open Sales Invoice/CR/Adj Note** action.  
