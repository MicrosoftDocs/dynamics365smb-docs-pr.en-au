...
5. In the **Quantity** field, enter the number of items to be purchased.
    ...
    The price and line amount are shown with or without GST depending on what you selected in the **Prices Including Tax** field on the supplier card.
...
You can easily correct or cancel a posted purchase invoice before you pay the supplier. This is useful if you want to correct a typing mistake or if you want to change the purchase early in the order process. For more information, see [Correct or Cancel Unpaid Purchase Invoices](purchasing-how-correct-cancel-unpaid-purchase-invoices.md). If you have already paid for items or services on the posted purchase invoice, then you must create a purchase CR/Adj note to reverse the purchase. For more information, see [Process Purchase Returns or Cancellations](purchasing-how-process-purchase-returns-cancellations.md).
