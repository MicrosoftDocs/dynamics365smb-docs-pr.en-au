...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Post Service Orders and CR/Adj Notes
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>To post a service CR/Adj Note
...
2. Create a new service CR/Adj Note. Choose the **New** action.  
3. Fill in the necessary fields.  
4. Choose the **Post** action. If you want to print the CR/Adj note at the same time as you post, choose the **Post and Print** action instead.  
