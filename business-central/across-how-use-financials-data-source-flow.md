...
11. From the list of available templates, select one of the templates, and then choose **Create**.  
    ...
    - *Request Approval for Microsoft [!INCLUDE[prod_long](includes/prod_long.md)] sales CR/Adj Note*
    ...
    - *Request Approval for Microsoft [!INCLUDE[prod_long](includes/prod_long.md)] purchase CR/Adj Note*  
