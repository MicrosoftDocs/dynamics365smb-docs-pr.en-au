...
* A CR/adj note that you have created must be released by the manager responsible for approving all refunds.
...
> [!NOTE]
> If you want to post a single open order or CR/adj note without releasing it first, the program will automatically release the document when you post it. If you post your orders or CR/Adj notes by using the **Post Batch** function, you can choose only to post the orders or CR/Adj notes that you have released.
