...
description: Learn about the 'Open' and 'Released' status on quote, order, or CR/Adj note documents.
author: brentholtorf
...
ms.locfileid: "9728635"
---
# <a name="status-field-on-documents"></a>Status Field on Documents

When you create a quote, order, or CR/Adj note, the **Status** field on the document header contains the status **Open** by default.
...
* The manager responsible for approving all refunds must release a CR/Adj note that you've created.
...
> [!NOTE]
> If you want to post a single open order or CR/Adj note without releasing it first, [!INCLUDE [prod_short](includes/prod_short.md)] will automatically release the document when you post it. If you post your orders or CR/Adj notes by using the **Post Batch** function, you can choose to post only the orders or CR/Adj notes that you've released.
