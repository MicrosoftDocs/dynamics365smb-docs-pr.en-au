...
4. In the **Customer No.** field, enter the number of the customer in the service contract.  
    ...
    > [!NOTE]  
    >  You can compare the CR/Adj Note to the original posted document in the **Posted Service Invoices** window. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Posted Service Invoices**, and then choose the related link.  
