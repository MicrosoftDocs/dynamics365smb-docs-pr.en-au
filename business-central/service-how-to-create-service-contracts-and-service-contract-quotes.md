...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>To create contract service CR/Adj Notes
...
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Service CR/Adj Notes**, and then choose the related link.  
...
4. In the **Customer No.** field, enter the number of the customer in the service contract.  
    ...
    > [!NOTE]  
    >  You can compare the CR/Adj Note to the original posted document on the **Posted Service Invoices** page. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Posted Service Invoices**, and then choose the related link.  
...
6. On the CR/adj note lines, enter information about the items that have been returned or removed, or the allowance that will be sent. You can also use the **Get Prepaid Contract Entries** batch job.  
 ...
 To automatically create a CR/Adj Note when contract lines are removed from a service contract, on the **Service Contract** page, on the **Invoice Details** FastTab, select the **Automatic CR/Adj Notes** check box.  

 To manually create a CR/Adj note when contract lines are removed from a service contract, on the **Service Contract** page, choose the **CR/Adj Note** action.  
