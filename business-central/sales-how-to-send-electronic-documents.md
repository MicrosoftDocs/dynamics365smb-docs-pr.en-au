...
description: Learn how to use Business Central to send electric invoices and CR/Adj notes in the PEPPOL format.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
