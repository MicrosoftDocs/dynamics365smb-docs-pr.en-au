...
> [!TIP]
> You can let [!INCLUDE[prod_short](includes/prod_short.md)] validate Exemption Certification numbers and other company information when you create or update documents. For more information, see [Validate Exemption Certification numbers](finance-how-validate-vat-registration-number.md).
...
[Validate a Exemption Certification number](finance-how-validate-vat-registration-number.md)  
